...
{
  mkdir($thumbs_path, 0777, true); // or even 01777 so you get the sticky bit set         
}
if(!is_dir($current_path))
{
  mkdir($current_path, 0777, true); // or even 01777 so you get the sticky bit set         
}
